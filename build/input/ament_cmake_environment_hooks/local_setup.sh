...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/ros2_ws/object-detection-jai0307-notatallVishal/install/input"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/input/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/input/environment/path.sh"
